...
function handleBookingSearch() {
    ...
    // Simulate search
    showNotification('Buscando tu odisea perfecta...', 'info');
    
    setTimeout(() => {
        window.location.href = `destinations.html?destination=${encodeURIComponent(destination)}&checkin=${checkin}&checkout=${checkout}`;
    }, 1500);
}
